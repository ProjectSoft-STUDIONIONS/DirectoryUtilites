...
+ **RenderParams** плагин рендера параметров у модулей, сниппетов, плагинов. Исправлено отображение параметра типа `int`, добавлена поддержка параметра типа `color`
